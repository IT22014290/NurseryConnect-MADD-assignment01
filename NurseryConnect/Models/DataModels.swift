...
class AppState {
    ...
    var currentUserName: String = "Sarah Johnson"
    var currentRoom: String = "Sunshine Room"
    var parentChildName: String = "Olivia"
    var parentChildId: UUID = UUID()
    var unreadMessages: Int = 2
    var pendingIncidents: Int = 1
...
enum UserRole: String, CaseIterable, Identifiable {
    ...
    var color: Color {
        ...
        case .settingManager: return NurseryTheme.primary
        case .keyworker:      return NurseryTheme.teal
        case .roomLeader:     return NurseryTheme.purple
        case .driver:         return NurseryTheme.orange
        case .parent:         return NurseryTheme.pink
        case .catering:       return NurseryTheme.red
        case .marketing:      return NurseryTheme.indigo
        }
    }

    var description: String {
        switch self {
        case .administrator:  return "System configuration & compliance"
        case .settingManager: return "Operational oversight & reporting"
        case .keyworker:      return "Daily child monitoring & care"
        case .roomLeader:     return "Room oversight & staff supervision"
        case .driver:         return "Transport & school collections"
        case .parent:         return "View child diary & notifications"
        case .catering:       return "Meal planning & allergen management"
        case .marketing:      return "Social media & GDPR-safe content"
        }
    }
}
